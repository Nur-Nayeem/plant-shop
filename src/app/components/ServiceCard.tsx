...
const ServiceCard = ({ img, stl, header }: { img: StaticImageData, stl: string, header: string }) => {
    return (
        <div style={{
            ...
            <div className=' flex items-center justify-center max-w-[105px] h-[92px] bg-[rgba(238,255,244,1)] -rotate-[33.13deg] rounded-[66px] rounded-b-[114px] '>
                <Image
                    className='max-w-14 h-14 rotate-[33.13deg]'
                    src={img}
                    alt="Image 1"
                />
            </div>
